...
% Run with: n2d_regional_template('n2d_regional_test_racmo_eps1e_02_kappa5e_11_mu5e00_partition1e_01_k01e_01_V1e1_drainage_highelev')

run(fullfile(fileparts(mfilename('fullpath')), 'nevis_regional.m'));

cfg.casename = 'n2d_regional_test_racmo_eps1e_02_kappa5e_11_mu5e00_partition1e_01_k01e_01_V1e1_drainage_highelev';
cfg.case_root = './cases';
...
cfg.initial_hydrology.result_case = 'n2d_regional_test_racmo_eps1e_02_kappa5e_11_mu5e00_partition1e_01_k01e_01_spinup';
