...
% Run with: n2d_regional_template('n2d_regional_test_racmo_eps1e_02_kappa5e_11_mu5e00_partition4e_01_k01e_01_spinup')

run(fullfile(fileparts(mfilename('fullpath')), 'nevis_regional.m'));

cfg.casename = 'n2d_regional_test_racmo_eps1e_02_kappa5e_11_mu5e00_partition4e_01_k01e_01_spinup';
cfg.case_root = './cases';
