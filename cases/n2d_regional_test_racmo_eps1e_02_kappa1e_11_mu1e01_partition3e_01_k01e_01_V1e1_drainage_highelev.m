% Auto-generated regional NEVIS ice-dynamics drainage case config.
% Generated by ./srcgen/ice_dynamics_scripts.py.
% Run with: n2d_regional_template('n2d_regional_test_racmo_eps1e_02_kappa1e_11_mu1e01_partition3e_01_k01e_01_V1e1_drainage_highelev')

run(fullfile(fileparts(mfilename('fullpath')), 'nevis_regional.m'));

cfg.casename = 'n2d_regional_test_racmo_eps1e_02_kappa1e_11_mu1e01_partition3e_01_k01e_01_V1e1_drainage_highelev';
cfg.case_root = './cases';
...
cfg.initial_hydrology.result_case = 'n2d_regional_test_racmo_eps1e_02_kappa1e_11_mu1e01_partition3e_01_k01e_01_spinup';
cfg.initial_hydrology.timestep_file = '0365.mat';
