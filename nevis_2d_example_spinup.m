...
oo.casename = 'n2d_100m3s_kappa1e_10_mu1e1_hbreg1e_3_spinup';    
                                               % casename
...
pd.hb_reg1 = 1e-3;                                 % Regularisation parameter for hb, representing the thickness of the prewetted layer
...
pd.alpha_dh = 0;                                % leakage dependence on h, reference value 1.1574e-6 [1/(m s)]
pd.alpha_ds = 0;                                % leakage dependence on S, reference value 1.5595e-5 [1/(m^2 s)]
% non-dimensionalise
ps = struct;
