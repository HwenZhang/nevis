...
oo.casename = 'n1d_Vconst_cg0_00_a0_kh0_ks0_mu1e_1_c1_V1e7';           
                                               % casename
...
b = 4e3/ps.z - 0.01*gg.nx*ps.x/ps.z;   % bed slope angle = 0.01
s = 1000/ps.z + b;
...
oo.t_span = (1:1.0:1000)*pd.td/ps.t;             % time span for simulation (in ps.t)
