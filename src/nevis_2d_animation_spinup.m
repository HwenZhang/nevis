...
casename = 'n2d_10m3s_kappa1e_10_mu1e1_hbreg5e_3_spinup';  % specify the case name
...
ax = nexttile(rightLayout);
zhe = pd.hb_reg1 + (ps.hb)*reshape(vva.hb,gg.nI,gg.nJ); 
...
for i_t = t_init:t_end
    ...
    % pblister.CData = (ps.phi/1e6)*reshape(vva.pb,gg.nI,gg.nJ); 
