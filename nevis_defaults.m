...
if ~isfield(pd,'k_bed'), pd.k_bed = 4.0e-12; end                    % ice bed permeability (m^2)
...
if ~isfield(pd,'Q_0'), pd.Q_0 = 5.0e2; end                          % scale for influx from the lake to the blister (m^3/s)
