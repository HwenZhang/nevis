...
oo.casename = 'n2d_region_test_meanperms1_Hreg1000_kappa1e_99_mu2e1_spinup_test';    % casename
...
pp.y_l = -15*(1e3/ps.x);                                  % y-coord of lakes
pp.V_l = [180000000.0/(ps.Q0*ps.t)];                              % volume of lakes
...
oo.t_span = [(1:1:29)*pd.td/ps.t (29.9:0.001:30.1)*pd.td/ps.t (31:1:365)*pd.td/ps.t]; 
