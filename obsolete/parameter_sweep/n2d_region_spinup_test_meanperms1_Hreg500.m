...
% Date: 2025-09
% Parameters: oo.mean_perms=1, pd.H_reg_value=pd.Ye*(500)^3/(12*(1-0.33)^2)
format compact
...
oo.casename = 'n2d_region_spinup_test_meanperms1_Hreg500';    % casename
...
pd.B_reg = pd.Ye*(500)^3/(12*(1-0.33)^2);      % Reg parameter for bending stiffness
