    ...
    % Date: 2025-09
    % Parameters: oo.mean_perms=1, pd.H_reg_value=pd.Ye*(1000)^3/(12*(1-0.33)^2), pd.kappa_b=1e-10, pd.k_s=0.001
    format compact
    ...
    oo.casename = 'n2d_region_melt_meanperms1_Hreg1000_kappa1e_10_ks1e_03_mu1e1_spinup';    % casename
    ...
    pd.k_s = 0.001;                                  % sheet permeability constant
    ...
    % oo.t_span = [(1:1:180)*pd.td/ps.t (180.01:0.05:240)*pd.td/ps.t (241:1:365)*pd.td/ps.t];
