    ...
    % Date: 2025-09
    % Parameters: oo.mean_perms=1, pd.H_reg_value=pd.Ye*(1000)^3/(12*(1-0.33)^2), pd.kappa_b=1e-09, pd.k_s=0.01
    format compact
    ...
    oo.casename = 'n2d_region_melt_meanperms1_Hreg1000_kappa1e_09_ks1e_02_mu2e1_spinup';    % casename
