...
oo.casename = 'n2d_100m3s_alpha1e_1_dalphad0_1_dalphads1e3_mu1e3_V1e7';   
...
pd.alpha_ds = 1.5595e-2;                        % alpha for the change in hb, used in the relaxation term [1/(m^2 s)]
...
% [(1:1:3*365-1)*pd.td/ps.t (3*365:0.2:3*365+40)*pd.td/ps.t (3*365+41:1:4*365)*pd.td/ps.t]
oo.t_span = [(1:1:3*365-1)*pd.td/ps.t (3*365:0.2:3*365+40)*pd.td/ps.t (3*365+41:1:4*365)*pd.td/ps.t];
