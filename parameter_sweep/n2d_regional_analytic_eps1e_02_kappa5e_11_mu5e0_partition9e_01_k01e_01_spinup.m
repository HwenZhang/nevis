...
oo.casename = 'n2d_regional_analytic_eps1e_02_kappa5e_11_mu5e0_partition9e_01_k01e_01_spinup';                     % casename
...
oo.partition_ratio = 0.9;
oo.iterative_solver = 0;

pd.alpha_b = 0;                                 % relaxation rate (s^-1)
pd.kappa_b = 5e-11;                           % relaxation coeff

% alter default parmaeters 
pd.mu = 5.0;                                    % water viscosity (Pa s)
