...
casename = 'n2d_0m3s_kappa1e_20_mu1e_1_hbreg5e_3_V1e6_drainage'; % drainage system filename
initname = strrep(casename, '_V1e6_drainage', '_spinup'); % initial condition filename
...
pp.x_l = [0.5*L/ps.x];                                          
pp.y_l = [0.5*W/ps.x];                                          
pp.V_l = [1e6/(ps.Q0*ps.t)];                           % different V_l values
