...
oo.casename = 'test_2009_140km_mu2e1_kappa0';     % casename
...
%% grid and geometry
load('./data/nevis_regional/morlighem_for_nevis_140km'); % load Morlighem bedmap (previously collated)
