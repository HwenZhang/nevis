...
oo.casename = 'n2d_prewetted_test';            % casename
...
pd.hb_reg1 = 5e-3;                              % regularizing thickness of blister [m]
...
y = linspace(0,(L/ps.x),Nx);            % 1-d grid of length 50km 
...
vv.hb = 1e-3*ones(size(vv.hs));                        % initial blister sheet thickness
