...
clear 
casename = 'nevis_ice_example_spinup_mu1e1_kappa1e_10_eps0_1';
...
%% initialize
init_cond = load(['./results/' initname '/' '1825.mat']); % load initial condition
...
oo.save_timesteps = 1; 
oo.save_pts_all = 1; 
oo.t_span = vv.t + (0:0.25:365*0.5)*pd.td/ps.t;         
